      ...
      <CardContent className="p-4" style={{ maxWidth: '100%', overflow: 'hidden' }}>
        ...
        <div className="flex items-center gap-2 mb-4" style={{ maxWidth: '100%', overflow: 'hidden' }}>
          <div className="flex-1 relative" style={{ maxWidth: 'calc(100% - 80px)' }}>
            <input
              type="text"
              className="flex w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-background placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
              placeholder="Add custom negative term..."
              value={customInput}
